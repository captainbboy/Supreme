...
public class SupremeAttribute {
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_MAGIC = {new SlimefunItemStack(SupremeCetrus.CETRUS_LUX, 1).item(),
      ...
      new SlimefunItemStack(SupremeCetrus.CETRUS_AQUA, 1).item(), new ItemStack(Material.NETHER_WART, 64),
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_BOMB = {new SlimefunItemStack(SupremeCetrus.CETRUS_IGNIS, 1).item(),
      ...
      new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1).item(), new ItemStack(Material.GUNPOWDER, 64),
      new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1).item(), new SlimefunItemStack(SupremeCetrus.CETRUS_IGNIS, 1).item(),
      new SlimefunItemStack(SupremeCore.CORE_OF_BLOCK, 1).item(), new SlimefunItemStack(SupremeCetrus.CETRUS_IGNIS, 1).item()};
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_FORTUNE = {new ItemStack(Material.DIAMOND_BLOCK, 64),
      ...
      new SlimefunItemStack(SupremeAttribute.getMagic(), 1).item(), new ItemStack(Material.OBSIDIAN, 64),
